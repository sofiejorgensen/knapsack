...
#     
#     print(res_list[2,])
#     # return(res_list, subset_list[[which.max(res_list$value,]][res_list$elements[]])
#     # return(res_list)
...
#     stopCluster(cl)
#     
#     unlisted <- unlist(val_vector)
#     
#     elements <- if(length(which(max(unlist(val_vector)) > 1))) {
#       0
#     } else {
#       which(max(unlist(val_vector)) == val_vector)
#     }
#   
#     value <- if(length(which(max(unlist(val_vector)) > 1))) {
#       0
#     } else {
#       max(unlist(val_vector))
#     }
#     
#     print(length(max(unlist(val_vector[1])) > 1))
# 
#     ret_df <- data.frame("value" = value, "elements" = elements)
#     # print(as.vector(unlist(val_vector)))
# 
